...
func remove_barrier():
	...
	if barrier_open == 0 :
		...
		$Barriers2.queue_free()
	elif barrier_open == 4 :
		$Barriers3.queue_free()
	elif barrier_open == 6 :
		$Barriers4.queue_free()
	elif barrier_open == 8 :
		$Barriers5.queue_free()
	elif barrier_open == 10 :
		$Barriers6.queue_free()
	elif barrier_open == 12 :
		$Barriers7.queue_free()
	elif barrier_open == 14 :
		$Barriers8.queue_free()
	elif barrier_open == 16 :
		$Barriers9.queue_free()
	elif barrier_open == 18 :
		$Barriers10.queue_free()
	else:
